...
## System Architecture
- Primary language: lua, html, css, etlua
- Framework: lapis running on openresty

## Build and Run Commands
- never install new dependencies on your own. Suggest them to me instead
- The set up is a docker container you're allowed to run. Don't touch any files outside ~/documents/development/stadius
